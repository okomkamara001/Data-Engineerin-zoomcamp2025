#  Homework 2: Workflow orchestration for Data Engineering zoomcamp
...
## Q2. What is the rendered value of the variable file when inputs taxi is set to green, year is set to 2020, and month is set to 04 during execution?

> B: green_tripdata_2020_04.csv

##  Q3. How many rows are there for the yellow Taxi data for all CSV in the year 2020?

> B: 24,648,499

## Q4: How many rows are there for the green Taxi data for all CSV in the 2020?
